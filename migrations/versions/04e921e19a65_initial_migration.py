...
def upgrade():
    ...
    sa.Column('document_type', sa.Enum('Instructions', 'Policies and Procedures', 'Templates', 'Training Materials', 'COVID-19 Information', 'Records Management', name='document_type'), nullable=True),
