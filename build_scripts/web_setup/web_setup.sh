...
# 6. Create ssl Certs
openssl req \
       -newkey rsa:4096 -nodes -keyout /vagrant/build_scripts/web_setup/intranet_dev.key \
       -x509 -days 365 -out /vagrant/build_scripts/web_setup/intranet_dev.crt -subj "/C=US/ST=New York/L=New York/O=NYC Department of Records and Information Services/OU=IT/CN=intranet.dev"
openssl x509 -in /vagrant/build_scripts/web_setup/intranet_dev.crt -out /vagrant/build_scripts/web_setup/intranet_dev.pem -outform PEM
