...
@manager.option("-m", "--minitial", dest='middle_initial', default='')
@manager.option("-l", "--lname", dest="last_name", default=None)
@manager.option("-e", "--email", dest="email", default=None)
@manager.option("-d", "--division", dest="division", default=None)
@manager.option("-p", "--phone", dest="phone_number", default=None)
@manager.option("-t", "--title", dest="title", default=None)
@manager.option("-r", "--room", dest="room", default=None)
@manager.option("--role", dest="role", default=None)
