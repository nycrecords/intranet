...
from app.utils.onelogin.saml2.settings import OneLogin_Saml2_Settings
from app.utils.onelogin.saml2.response import OneLogin_Saml2_Response
from app.utils.onelogin.saml2.logout_response import OneLogin_Saml2_Logout_Response
from app.utils.onelogin.saml2.constants import OneLogin_Saml2_Constants
from app.utils.onelogin.saml2.utils import OneLogin_Saml2_Utils, OneLogin_Saml2_Error, OneLogin_Saml2_ValidationError
from app.utils.onelogin.saml2.logout_request import OneLogin_Saml2_Logout_Request
from app.utils.onelogin.saml2.authn_request import OneLogin_Saml2_Authn_Request
...
class OneLogin_Saml2_Auth(object):
    ...
    def process_slo(self, keep_local_session=False, request_id=None, delete_session_cb=None):
        ...
        if get_data and 'SAMLResponse' in get_data:
            ...
            if self.__settings.get_security_data().get('logoutResponseSigned', False) and not self.validate_response_signature(get_data):
